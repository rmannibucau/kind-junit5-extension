...
🌐 https://yupiik.github.io/yupiik-junit-extension/
...
- Create https://github.com/yupiik/yupiik-junit-extension/issues[issues]
- Open https://github.com/yupiik/yupiik-junit-extension/discussions[discussions]
...
Yupiik yupiik-junit-extension is released under the Apache License, Version 2.0. See the LICENSE file for more details.

== ©️ Copyright
Copyright © 2025 Yupiik.

🌟 *Simplify your Java applications with Yupiik yupiik-junit-extension.* 🌟
